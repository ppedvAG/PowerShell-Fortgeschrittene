...
for ($i = 1; $i -le $FileCount; $i=$i+1) 
{
    ...
    New-Item -Path "$TestFileFolderpath\" -Name "File$filenumber.txt" -ItemType "file" -Value "Testinhalt" 
}
...
{ 
    ...
    { 
        New-Item -Path "$TestFileFolderpath\Ordner$i\" -Name "File$f.txt" -ItemType "file" -Value "Testinhalt"
    }      
}
